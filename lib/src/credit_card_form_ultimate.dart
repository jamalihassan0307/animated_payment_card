...
/// A perfect credit card form that exactly matches the Vue.js design
class CreditCardFormUltimate extends StatefulWidget {
  const CreditCardFormUltimate({
    super.key,
  ...
  @override
  State<CreditCardFormUltimate> createState() => _CreditCardFormUltimateState();
}

class _CreditCardFormUltimateState extends State<CreditCardFormUltimate> {
  ...
  void initState() {
    ...
    _cardNumberFocus.addListener(() {
      _updateFocus('cardNumber');
      _onCreditCardModelChange();
    });

    _cardHolderNameFocus.addListener(() {
      _updateFocus('cardName');
      _onCreditCardModelChange();
    });

    _expiryDateFocus.addListener(() {
      _updateFocus('cardDate');
      _onCreditCardModelChange();
    });
      ...
      child: Form(
        ...
        child: LayoutBuilder(
          builder: (context, constraints) {
            return Container(
              padding: EdgeInsets.all(constraints.maxWidth > 480 ? 35 : 25),
                      ...
                      if (constraints.maxWidth < 480) {
                        ...
                        return Column(
                          children: [
                            ...
                            if (widget.isCvvVisible) _buildCvvField(),
                          ],
                        );
                      } else {
