...
class _CreditCardWidgetState extends State<CreditCardWidget>
  ...
  void _setRandomBackground() {
    ...
    _backgroundImage = 'https://raw.githubusercontent.com/muhammederdem/credit-card-form/master/src/assets/images/$random.jpeg';
  }
  ...
  Widget _buildCardTypeIcon() {
    ...
    return Container(
      ...
      child: AnimatedSwitcher(
        duration: const Duration(milliseconds: 250),
        child: Image.network(
          'https://raw.githubusercontent.com/muhammederdem/credit-card-form/master/src/assets/images/$cardTypeImage.png',
